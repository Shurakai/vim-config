...
exec "Snippet elseif elseif ( ".st."condition".et." )<Space>{<CR><Tab>".st.et."<CR>}<CR>".st.et
exec "Snippet do do<Space>{<CR>".st.et."<CR><CR>} while ( ".st.et." );<CR>".st.et
...
exec "Snippet function ".st."public".et."function ".st."FunctionName".et." (".st.et.")<Space>{<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet if if ( ".st."condition".et." )<Space>{<CR><Tab>".st.et."<CR>}<CR>".st.et
...
" if HTML
exec "Snippet hif <?php if (".st."condition".et."): ?><CR><Tab>".st.et."<CR><?php endif ?><CR>".st.et
" ifelse HTML
exec "Snippet hifelse <?php if (".st."condition".et."): ?><CR><Tab>".st.et."<CR><?php else: ?><CR><Tab>".st.et."<CR><?php endif ?>"
" php HTML
exec "Snippet hphp <?php ".st.et." ?>"
" echo HTML
exec "Snippet hecho <?php echo ".st.et." ?>"
" foreach HTML
exec "Snippet hforeach <?php foreach ($".st."variable".et." as $".st."key".et." => $".st."value".et."): ?><CR><Tab>".st.et."<CR><?php endforeach ?>"
